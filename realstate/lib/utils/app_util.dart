...
class AppUtil {
  ...
  //return current language code 'ar' / 'en'
  // static String getCurrentLocal() {
  //   String languageCode = AppLocalizations.of(context: AppUtil.getContext()).locale.toString();
  //   return languageCode;
  // }
  ...
  //       return AppLocalizations.of(context: AppUtil.getContext()).translate(languageKey);
  //     } else {
  //       return languageKey;
  //     }
  //   } catch (e) {
  //     print(
  //         '<><><><><><><><><><> translation of -------> $languageKey <------- error,${e}');
  //     return languageKey;
  //   }
  // }
